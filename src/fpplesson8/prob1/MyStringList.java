...
public class MyStringList {
	...
	//find minimum of strArray between the indices bottom and top
	...
	System.out.println("The result of the search of keyword is: " + l.search("number"));
	System.out.println("The result of the search of keyword is: " + (l.search("tiny")));
